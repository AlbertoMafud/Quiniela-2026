...
const STAGE_PRETTY: Record<string, string> = {
  ...
  r32_picks: "Picks 32vos",
  r32_scores: "Marcadores 32vos",
  r16_picks: "Picks octavos",
  r16_scores: "Marcadores octavos",
  qf_picks: "Picks cuartos",
  qf_scores: "Marcadores cuartos",
  sf_picks: "Picks semis",
  sf_scores: "Marcadores semis",
  final_picks: "Picks final",
