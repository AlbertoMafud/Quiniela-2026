...
const STAGE_LABELS: Record<string, string> = {
  ...
  r32_picks: "Picks de R32 (bracket)",
  r32_scores: "Marcadores de R32",
  r16_picks: "Picks de R16 (bracket)",
  r16_scores: "Marcadores de R16",
  qf_picks: "Picks de cuartos (bracket)",
  qf_scores: "Marcadores de cuartos",
  sf_picks: "Picks de semis (bracket)",
  sf_scores: "Marcadores de semis",
  final_picks: "Picks de la final (bracket)",
